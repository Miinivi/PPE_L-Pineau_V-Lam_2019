...
<?php
      ...
      <p>
        <input id="ok" type="submit" value="Valider" size="20" 
               title="Enregistrer les nouvelles valeurs des éléments forfaitisés"  class="button"/>
      ...
      <p>
        <input id="ajouter" type="submit" value="Ajouter" size="20" 
               title="Ajouter la nouvelle ligne hors forfait" class="button"/>
        <input id="effacer" type="reset" value="Effacer" size="20" class="button"/>
      </p> 
      </div>
      </form>
...
<?php          
          ...
          ?>
              <tr>
                <td><?php echo $lgEltHorsForfait["id"] ; ?></td> <!--Cette ligne-->
